...
// of the process.
lazy_static! {
    static ref UNICODE_CLASS_TABLE: Box<[u8]> = {
        ...
        for i in 128..UNICODE_TABLE_SIZE {
            ...
            // Surrogates (U+D800..U+DFFF) and unassigned codepoints stay 0; they
            // can't appear in a valid Rust `&str` so never get looked up.
        }
        t
    };
}
