...
pub fn num_tokens_from_messages(
    ...
    for message in messages {
        ...
        num_tokens += bpe.count_with_special_tokens(message.role.as_str()) as i32;
        num_tokens +=
            bpe.count_with_special_tokens(message.content.as_deref().unwrap_or("")) as i32;
        if let Some(name) = &message.name {
            num_tokens += bpe.count_with_special_tokens(name.as_str()) as i32;
